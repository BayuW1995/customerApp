...
import id.net.gmedia.gmedialiveconnection.MainDetailEvent.DetailEvent;
...
public class ListEventAdapter extends RecyclerView.Adapter<ListEventAdapter.MyViewHolder> {
	...
	private List<ModelListEvent> masterList;
	...
	public ListEventAdapter(Context context, List<ModelListEvent> masterList, int menuWidth) {
	...
	public void onBindViewHolder(MyViewHolder holder, int position) {
		final ModelListEvent model = masterList.get(position);
		...
		iu.LoadPromoImage(context, model.getImage(), holder.ivIcon);*/

		Picasso.with(context).load(model.getImage()).into(holder.ivIcon);
