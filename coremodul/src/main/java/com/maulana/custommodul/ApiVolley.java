...
//                    Toast.makeText(context, e.toString(), Toast.LENGTH_LONG).show();
			...
			public Map<String, String> getHeaders() throws AuthFailureError {
				...
				params.put("Auth-Key", "frontend-app");
				params.put("Client-Service", "gmedia_client_router");
				params.put("User-Id", session.getUserID());
				params.put("Token", session.getToken());
				params.put("Contact-Id", session.getContactID());
